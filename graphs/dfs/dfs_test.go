...
func TestDFS(t *testing.T) {
	...
	visitedOrder := DFS("Frankfurt", g)
	assert.EqualValues(t, []string{"Frankfurt", "Kassel", "Munchen", "Augsburg", "Karlsruhue", "Mannhelm", "Nurnberg", "Stuttgart", "Wurzburg", "Erfurt"}, visitedOrder)
}
